...
module.exports = class InfoCommand extends Command {
    ...
    async run(msg) {
        ...
        const srvr = 'https://discord.gg/28JC8JYX';
        const vte = 'https://top.gg/bot/';
        const owners = 'https://cdn.discordapp.com/attachments/688763072864976906/705776573546233937/702557406361550848.gif';
        const webs = 'http://large-dandy-macaroon.glitch.me/#';
        const embed = new MessageEmbed()
            .setAuthor('Agata Stats', `${owners}`)
            .setThumbnail(this.client.user.displayAvatarURL()) //↣↢
            .setColor('#cce7e8')
            .setFooter('©Agata', `${this.client.users.cache.find(c => c.id === '766869255517241395').avatarURL()}`)
            .setTimestamp()
            ...
            .addField('**👤  Dev**', `\|\|<@766869255517241395> OR ${this.client.users.cache.find(c => c.id === '766869255517241395').tag}\|\|`);
